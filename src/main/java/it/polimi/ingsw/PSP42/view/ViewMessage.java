...
public class ViewMessage {
    public static String insertNumberOfPlayers = "Insert the number of Players: ";
    public static String insertName = "Insert your name, player: ";
    public static String insertAge = "Insert your age, player: ";
    public static String insertLevel = "Insert level: ";
    public static String selectCard = "Select one of the card in the set, player: ";
